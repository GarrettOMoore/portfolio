...
const Projects = (props) => {
    return(
        ...
        <p className='page-header'>Record Exchange</p>
        <img src={record} className='project-pic' width={'560px'} height={'560px'} />
        ...
        <p className='page-header'>Tumblin'</p>
        <img src={tumblin} className='project-pic' width={'560px'} height={'560px'}/>
        ...
        <p className='page-header'>Citizenly</p>
        ...
        <p className='page-header'>Starbunker (24hr Hackathon)</p>
