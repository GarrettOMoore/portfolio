...
const Projects = (props) => {
    return(
        ...
        <img src={crema} className='' width={'190px'} height={'350px'} />
        ...
        <img src={record} className='project-pic' width={'285px'} height={'285px'} />
        ...
        <img src={tumblin} className='project-pic' width={'285px'} height={'285px'}/>
        ...
        <img src={citizen} className='citizenly' width={'190px'} height={'350px'} />
        ...
        <img src={starbunker} className='citizenly'width={'190px'} height={'350px'}/>
